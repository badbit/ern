...
Begin VB.Form binario 
   Caption         =   "El Kódigo Binario y todas esas cosas -explicadas detatalladamente- por el kibitzer"
   ClientHeight    =   5928
   ClientLeft      =   396
   ClientTop       =   852
   ClientWidth     =   8244
...
Open "binario.txt" For Output As #1
Print #1, filehandler
Close #1
MsgBox ("Se ha grabado este archivo binario.txt"), , ("Extraer a archivo")
End Sub
