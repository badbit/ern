...
Begin VB.Form herrores 
   Caption         =   "La guía definitiva para hackear UNIX"
   ClientHeight    =   5292
   ClientLeft      =   876
   ClientTop       =   1056
   ClientWidth     =   7968
...
Open "hackunix.txt" For Output As #1
Print #1, filehandler
Close #1
MsgBox ("Se ha grabado este archivo a hackunix.txt"), , ("Extraer a archivo")
End Sub
