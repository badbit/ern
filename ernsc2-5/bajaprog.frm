...
Begin VB.Form bajaprog 
   Caption         =   "¿Eres adicto a internet?"
   ClientHeight    =   6168
   ClientLeft      =   108
   ClientTop       =   672
   ClientWidth     =   8544
...
Open "addiction.txt" For Output As #1
Print #1, filehandler
Close #1
MsgBox ("Se ha grabado este archivo a addiction.txt"), , ("Extraer a archivo")
End Sub
