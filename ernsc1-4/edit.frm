VERSION 4.00
Begin VB.Form bofhG 
   Caption         =   "El Operador Bastardo Del Infierno - Génesis"
   ClientHeight    =   6420
   ClientLeft      =   48
   ClientTop       =   504
   ClientWidth     =   9636
...
Open "bofh#G.txt" For Output As #1
Print #1, filehandler
Close #1
MsgBox ("Se ha grabado este archivo a bofh#G.txt"), , ("Extraer a archivo")
End Sub
