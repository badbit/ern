...
Begin VB.Form Forma1 
   ...
   Begin VB.Label Label2 
      ...
      Caption         =   "Leer El Radiaktivo Newz puede causar cáncer"
      ForeColor       =   &H00FFFFFF&
      Height          =   192
      Left            =   1560
      TabIndex        =   3
   ...
   Begin VB.Label Label3 
      BackStyle       =   0  'Transparent
      Caption         =   "Año I, número 5, Junio 1999"
   ...
   Begin VB.Menu articles 
      ...
      Begin VB.Menu dummies 
         Caption         =   "NetBus para &Dummies"
      End
      Begin VB.Menu herrors 
         Caption         =   "&Herrores de las películas"
      End
      Begin VB.Menu col 
         Caption         =   "Col&umnas"
   ...
   Begin VB.Menu utils 
      Caption         =   "&Utilidades"
      Begin VB.Menu dsdasdsdf 
         Caption         =   "P&review de WAR!!! (Ningún botón sirve)"
      End
...
MsgBox "Ayer no podía deletrear la palabra 'programador', ahora soy uno.", , "Frase del mes"
End Sub
