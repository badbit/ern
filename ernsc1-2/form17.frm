...
Begin VB.Form Form17 
   ...
   Begin VB.Label Label9 
      ...
      Caption         =   "Compre los chips INTEL, recuerde: Intel adentro, Idiota afuera."
      BeginProperty Font 
         name            =   "MS Sans Serif"
         charset         =   0
         weight          =   700
   ...
   Begin VB.Label Label11 
      BackColor       =   &H00C0FFFF&
      BackStyle       =   0  'Transparent
      Caption         =   "También puedes bajar la revista de: www.geocities.com/neighborhoods/ SiliconValey/Garage/8905/badbit.htm"
      BeginProperty Font 
         name            =   "MS Sans Serif"
         charset         =   0
         weight          =   700
